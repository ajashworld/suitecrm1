...
{counter name="panelFieldCount"  print=false}
<div {if $fields.list_type.value != "exempt_domain"} style='display:none'{/if} id='domain_name_div'><input tabindex="0"  name="domain_name" id="domain_name" maxlength="255" type="text" value="{$fields.domain_name.value}"></div>
</div>
