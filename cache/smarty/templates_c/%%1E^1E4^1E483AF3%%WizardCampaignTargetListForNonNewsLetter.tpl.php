<?php /* Smarty version 2.6.29, created on 2018-02-26 13:43:01
         compiled from modules/Campaigns/tpls/WizardCampaignTargetListForNonNewsLetter.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/Campaigns/tpls/WizardCampaignTargetListForNonNewsLetter.tpl', 287, false),array('function', 'sugar_getimage', 'modules/Campaigns/tpls/WizardCampaignTargetListForNonNewsLetter.tpl', 304, false),)), $this); ?>
<style>
	<?php echo '
	.form-control {
		border-radius: 0;
...
<?php echo ';
			...
			<ul class="target-list">
				...
				<li><input type="text" name="targetListSearch" value="" placeholder="<?php echo $this->_tpl_vars['MOD']['LBL_SEARCH_TARGET_LIST']; ?>
" style="width: 100%;"></li>
...
"><a href="javascript:;" onclick="addTargetListData('<?php echo $this->_tpl_vars['targetList']['id']; ?>
');" title="<?php echo $this->_tpl_vars['targetList']['description']; ?>
"><span class="targetListName"><?php echo $this->_tpl_vars['targetList']['name']; ?>
</span>&nbsp;-&nbsp;<span class="targetListType"><?php echo $this->_tpl_vars['targetList']['type']; ?>
</span>&nbsp;<span class="targetListCount">(<?php echo $this->_tpl_vars['targetList']['count']; ?>
)</span></a></li>
...
<br>
				<input id="target_list_name" name="target_list_name" type='text' size='35' placeholder="<?php echo $this->_tpl_vars['MOD']['LBL_TARGET_NAME']; ?>
" style="width: 100%;"><br>
...
<br>
				<select id="target_list_type" name="target_list_type" class="form-control input-sm"><?php echo $this->_tpl_vars['TARGET_OPTIONS']; ?>
</select>
				<input id='target_list_id' name='target_list_id' title='List ID' type="hidden" value=''>
				<br>
...
' class= 'button' onclick="add_target('false');">
			...
			<table width = '100%' class='detail view'>
				...
				<tr><td>
					...
					<table border=1 width='100%'><tr class='detail view'>
						<th scope='col' width='100' style="width:25%; text-align: left;"><b><?php echo $this->_tpl_vars['MOD']['LBL_TARGET_NAME']; ?>
</b></th>
						<th scope='col' width='100' style="width:25%; text-align: left;"><b><?php echo $this->_tpl_vars['MOD']['LBL_NUMBER_OF_TARGET']; ?>
</b></th>
						<th scope='col' width='100' style="width:25%; text-align: left;"><b><?php echo $this->_tpl_vars['MOD']['LBL_TARGET_TYPE']; ?>
</b></th><td>&nbsp;</td>
